...
public class TileEntitySmeltingForge extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.smelting_forge";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockSmeltingForge.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	{
		//higher the number, slower the time it takes to smelt.
		return 500;
	}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = SmeltingForgeRecipes.getInstance().getSmeltingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = SmeltingForgeRecipes.getInstance().getSmeltingResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
